...
class CAPARes_Unet(nn.Module):
    def __init__(self):
        super(CAPARes_Unet,self).__init__()
        self.encoder1 = Conv_Block(1,64)
        self.down1 = nn.Sequential(
            BasicConv2d(64, 64, 3, 2, 1),
            PreActivateResBlock(64, 64)
        )
        
        self.encoder2 = Conv_Block(64,128)
        self.down2 = nn.Sequential(
            BasicConv2d(128, 128, 3, 2, 1),
            PreActivateResBlock(128, 128)
        )
        
        self.encoder3 = Conv_Block(128,256)
        self.down3 = nn.Sequential(
            BasicConv2d(256, 256, 3, 2, 1),
            PreActivateResBlock(256, 256)
        )
        
        self.encoder4 = Conv_Block(256,512)
        self.down4 = nn.Sequential(
            BasicConv2d(512, 512, 3, 2, 1),
            PreActivateResBlock(512, 512)
        )
